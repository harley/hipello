...
module Hipello
  class TrelloHandle
    ...
    def room_url(room)
      # TODO: add timestamp
      # binding.pry
      ENV['HIPCHAT_ROOM_BASE_URL'] + room.attributes['hipchat_id']
    end
    ...
    def create_card_in(mentions: [], hashtag:, sender:, room:, title:, description: '')
      description << "\n-- added by #{sender} from #{message_url(room)}"
